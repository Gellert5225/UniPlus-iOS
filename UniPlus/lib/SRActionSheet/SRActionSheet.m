...
- (void)setupActionSheetView {
    ...
    if (self.title && self.title.length > 0) {
        [self.actionSheetView addSubview:({
            ...
            titleLabel.font            = [UIFont fontWithName:@"SFUIText-Regular" size:kTitleFontSize];
    ...
    if (self.otherButtonTitles && self.otherButtonTitles.count > 0) {
        for (int i = 0; i < self.otherButtonTitles.count; i++) {
            [self.actionSheetView addSubview:({
                ...
                otherBtn.titleLabel.font = [UIFont fontWithName:@"SFUIText-Regular" size:kButtonTitleFontSize];
                [otherBtn setTitleColor:[UIColor colorWithRed:53/255.0 green:111/255.0 blue:177/255.0 alpha:1.0] forState:UIControlStateNormal];
    ...
    if (self.destructiveButtonTitle && self.destructiveButtonTitle.length > 0) {
        ...
        [self.actionSheetView addSubview:({
            ...
            destructiveButton.titleLabel.font = [UIFont fontWithName:@"SFUIText-Regular" size:kButtonTitleFontSize];
    ...
    [self.actionSheetView addSubview:({
        ...
        cancelBtn.titleLabel.font = [UIFont fontWithName:@"SFUIText-SemiBold" size:kButtonTitleFontSize];
        [cancelBtn setTitleColor:[UIColor colorWithRed:53/255.0 green:111/255.0 blue:177/255.0 alpha:1.0] forState:UIControlStateNormal];
...
- (void)show {
    ...
    [UIView animateWithDuration:0.6 delay:0 usingSpringWithDamping:0.6f initialSpringVelocity:0.0
