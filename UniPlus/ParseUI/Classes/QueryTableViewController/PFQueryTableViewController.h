...
@property (nonatomic) NSInteger pageToLoad;
/**
...
@property (nonatomic, strong) PFObject *lastObject;
 ...
 */
@property (nullable, nonatomic, copy) NSArray<__kindof PFObject *> *objects;
